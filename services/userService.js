...
(function () {
  ...
  // Escuta evento firebase:ready
  window.CH.EventBus?.on('firebase:ready', () => {
    setTimeout(inicializar, 300); // pequeno delay para garantir _db pronto
  });

  // Tenta na inicialização (retry automático até Firebase estar pronto)
  setTimeout(_autoInicializar, 800);
